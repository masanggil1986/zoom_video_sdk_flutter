/**
 * @file zoom_video_sdk_audio_setting_interface.h
 * @brief Audio setting helper interface.
 */
...
/**
 * @brief Enumeration of background noise suppression levels.
 */
typedef enum
{
...
/**
 * @brief Enumeration of audio device status types.
 */
typedef enum {
...
/**
 * @brief Enumeration of echo cancellation levels.
 */
typedef enum {
 ...
 * @brief Helper interface for testing audio devices before or during a session.
 */
class IZoomVideoSDKTestAudioDeviceHelper
{
public:
...
public:	
	 ...
	 * @param bEnable true to enable the function, false to disable.
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error.  
	...
	/**
	 * @brief Determines whether the auto adjust input of the microphone volume is enabled.
	 * @param [out] bEnable true if auto adjust input is enabled, otherwise false.
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error. 
	 */
