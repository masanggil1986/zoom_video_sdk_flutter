...
public:
	 ...
	 * @return true if the CRC is enabled. Otherwise, false.
     ...
     * @return If the function succeeds, the return value is the live session SIP address when the CRC is enabled. Otherwise, this function fails and returns the string of length zero(0).
	 */
