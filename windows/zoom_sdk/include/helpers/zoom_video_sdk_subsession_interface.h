...
public:
	...
	* @return If the function succeeds, it returns an array of ISubSessionUser. Otherwise, this function fails and returns nullptr.
	*/
...
public:
	 ...
	 * @return If the function succeeds, it returns an array of ISubSessionKit. Otherwise, this function fails and returns nullptr.
	 */
