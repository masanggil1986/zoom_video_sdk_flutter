/**
 * @file zoom_video_sdk_livetranscription_helper_interface.h
...
public:
	 ...
	 * @return If the function succeeds, the return value is the message ID of the current message. Otherwise, this function fails and returns the string of length zero(0).
	 */
...
public:
	 ...
	 * @return true if the feature to receive original and translated is available. Otherwise, false.
	 */
	 ...
	 * @return true if the view history translation message is available. Otherwise, false.
	 */
