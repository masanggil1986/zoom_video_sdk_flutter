...
/**
 * @brief Enumeration of video rotation angles.
 */
typedef enum
{
...
public:
	 ...
	 * @return The video device ID if successful. Otherwise, this function fails and returns nullptr.
	 */
	 ...
	 * @param [out] bCan true if able, false if not. It validates only when the return value is ZoomVideoSDKErrors_Success.
	...
	/**
	 * @brief Automatically adjusts user's video solution and frame-rate.
	 ...
	 * @return true if the aspect ratio is original. Otherwise, false.
	 */
	virtual bool isOriginalAspectRatioEnabled() = 0;
	
	/**
	 * @brief This function is used to set the aspect ratio of the video sent out.
	 * @param bEnabled true indicates to use the original aspect ratio of video, false indicates to use 16:9.
	 * @return true if successful. Otherwise, false.
	 ...
	 * @return true if alpha channel mode can be enabled. Otherwise, false.
	 */
	virtual bool canEnableAlphaChannelMode() = 0;
	
	/**
	 * @brief Enable or disable video alpha channel mode.
	 * @param enable true to enable alpha channel mode, false to disable.
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error.  
	 */
	 ...
	 * @return true if alpha channel mode is enabled. Otherwise, false.
	 */
     ...
     * @return true if the current device supports it. Otherwise, false.
	 */
