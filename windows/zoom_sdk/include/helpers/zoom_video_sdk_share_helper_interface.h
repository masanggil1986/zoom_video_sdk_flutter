...
public:
     ...
     * @return If the function succeeds, the return value is the monitor ID list. Otherwise, this function fails and returns nullptr.
	 */
...
public:
     ...
     * @return true if the user is able to request to remote control the specified user. Otherwise, false.
	 */
     ...
     * @return true if the user is able to remote control the specified user. Otherwise, false.
	 */
     ...
     * @return true if the specified user is being remotely controled. Otherwise, false.
	 */
...
public:
	 ...
	 * @return true if annotation privilege is enabled. Otherwise, false.
	 */
     ...
     * @return If the function succeeds, the return value is the remote control helper object. Otherwise, this function fails and returns nullptr.
	 */
     ...
     * @return If the function succeeds, the return value is the list of users I have agreed to control. Otherwise, this function fails and returns nullptr.
	 */
...
public:
	...
	/**
	 * @brief Determines whether the handle being shared is valid.
     ...
     * @return If the function succeeds, the return value is the monitor ID list builder object. Otherwise, this function fails and returns nullptr.
	 */
     ...
     * @param isPlaying true to play audio raw data locally at the same time, false to not play.
     * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error.
	 ...
	 * @return true if the current user is sharing. Otherwise, false.
	 */
    virtual bool isSharingOut() = 0;
	
	/**
	 * @brief Determines whether the current user is sharing the screen.
     * @return true if the current user is sharing the screen. Otherwise, false.
	 */
    virtual bool isScreenSharingOut() = 0;
	
	/**
	 * @brief Determines if other user is sharing.
     * @return true if another user is sharing. Otherwise, false.
	 */
    virtual bool isOtherSharing() = 0;
	
	/**
	 * @brief Lock sharing the view or screen. Only the host can call this method.
     * @param lock true to lock sharing, false to unlock.
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error.  
	 */
    virtual ZoomVideoSDKErrors lockShare(bool lock) = 0;
	
    /**
	 * @brief Determines whether sharing is locked.
     * @return true if sharing is locked. Otherwise, false.
	 */
	...
	/**
	 * @brief Determines if the SDK has enabled share device sound. This reflects the execution status of `enableShareDeviceAudio` instead of `startShareComputerAudio`.
     * @return true if enabled. Otherwise, false.
	 */
	...
	/**
	 * @brief Determines if optimization for shared video is enabled.
     * @return true if enabled. Otherwise, false.
	 */
     ...
     * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error.  
     * @deprecated Use \link IZoomVideoSDKRawDataPipe->subscribe \endlink instead.
	 */
     ...
     * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error.  
     * @deprecated Use \link IZoomVideoSDKRawDataPipe->unSubscribe \endlink instead.
	 */
	 ...
	 * @return true if the annotation feature is supported. Otherwise, false.
	 */
	virtual bool isAnnotationFeatureSupport() = 0;
	
	/**
	 * @brief Disable or enable viewer's annotation by the share owner.
	 * @param bDisable true to disable, false otherwise.
	 ...
	 * @return If the function succeeds, the return value is the IZoomVideoSDKAnnotationHelper helper object. Otherwise, this function fails and returns nullptr. For more details, see \link IZoomVideoSDKAnnotationHelper \endlink.
	 * @note This method should be called after onUserShareStatusChanged() reports ZoomVideoSDKShareStatus_Start.
     ...
     * @param isPlaying true to play shared audio raw data, false to not play.
	 */
	...
	/**
	 * @brief Sets share transparent window or not when sharing.
	 * @param hWnd The window handle of the transparent window that you want to share or not.
	 * @param bShare true to share the transparent window, false to not share.
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error.
	 ...
	 * @return If the function succeeds, the return value is the whiteboard helper object. Otherwise, this function fails and returns nullptr. For more details, see \link IZoomVideoSDKWhiteboardHelper \endlink.
	 */
